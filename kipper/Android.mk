...
LOCAL_MODULE_OWNER := wileyfox
LOCAL_SRC_FILES := proprietary/app/Superuser/Superuser.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
include $(CLEAR_VARS)
LOCAL_MODULE := LuckyPatcher
LOCAL_MODULE_OWNER := wileyfox
LOCAL_SRC_FILES := proprietary/app/LuckyPatcher/LuckyPatcher.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
LOCAL_MODULE := FDroid
LOCAL_MODULE_OWNER := wileyfox
LOCAL_SRC_FILES := proprietary/app/FDroid/FDroid.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
LOCAL_MODULE_OWNER := wileyfox
LOCAL_SRC_FILES := proprietary/app/WFCamera/WFCamera.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
